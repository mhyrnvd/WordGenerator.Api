...
namespace WordGenerator.Api.Migrations
{
    ...
    [Migration("20260707212400_AddPerfaceAndConcepts")]
    partial class AddPerfaceAndConcepts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WordGenerator.Api.Domain.Entities.BulletList", b =>
                {
                    ...
                    b.ToTable("BulletLists", (string)null);
                });

            modelBuilder.Entity("WordGenerator.Api.Domain.Entities.BulletListItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WordGenerator.Api.Domain.Entities.HeaderLogo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PageHeaderId", "Order");

                    b.ToTable("HeaderLogos", (string)null);
                });
            ...
            modelBuilder.Entity("WordGenerator.Api.Domain.Entities.HeaderLogo", b =>
                {
                    b.HasOne("WordGenerator.Api.Domain.Entities.PageHeader", "PageHeader")
                        .WithMany("Logos")
            ...
            modelBuilder.Entity("WordGenerator.Api.Domain.Entities.PageHeader", b =>
                {
                    b.HasOne("WordGenerator.Api.Domain.Entities.DocumentTemplate", "DocumentTemplate")
                        .WithOne("PageHeader")
                        .HasForeignKey("WordGenerator.Api.Domain.Entities.PageHeader", "DocumentTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
